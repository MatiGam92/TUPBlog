    ...
    <div class="flex flex-col items-center justify-center min-h-screen w-full p-4 bg-gray-900">
        <div class="w-full max-w-md p-6 bg-purple-900 bg-opacity-75 rounded-lg shadow-lg">
            ...
            <div class="mt-4 flex flex-col space-y-4">
                ...
                <a href="{{ route('profile.edit') }}" class="w-full text-white bg-gray-700 hover:bg-purple-950 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    Perfil
                </a>
            </div>
